# -*- coding: utf-8 -*-
# Generated by Django 1.9 on 2017-12-26 21:46
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('additional_details', models.CharField(blank=True, max_length=512, null=True)),
                ('agent', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('relates_to', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='tracker.Event')),
            ],
        ),
        migrations.CreateModel(
            name='LabelTag',
